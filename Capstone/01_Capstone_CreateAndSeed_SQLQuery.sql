...
VALUES
  (1, 'Standing Deep Breathing', 'Praṇayama', null, null),
  (2, 'Half Moon Pose with Hands-to-Feet', 'Ardha Chandrasana with Padahastasana', null, null),
  (3, 'Awkward Pose', 'Utkatasana', null, null), 
  (4, 'Eagle Pose', 'Garudasana', null, null),
  (5, 'Standing Knee-to-Head', 'Dandayamana Janushirasana', null, null),
  (6, 'Standing Bow Pose', 'Dandayamana Danyurasana', null, null),
  (7, 'Balancing Stick Pose', 'Tuladandasana', null, null),
  (8, 'Standing Separtate-Leg Stretching Pose', 'Dandayamana Bibhaktapada Paschimottanasana', null, null),
  (9, 'Triangle Pose', 'Trikanasana', null, null),
  (10, 'Standing Separate Leg Head-to-Knee', 'Dandayamana Bibhaktapada Janushirasana', null, null),
  (11, 'Tree', 'Tadasana', null, null),
  (12, 'Toe Stand', 'Padangustasana', null, null),
  (13, 'Corpse Pose', 'Savasana', null, null),
  (14, 'Wind Removing Pose', 'Pavanamuktasana', null, null),
  (15, 'Sit-Up', null, null, null),
  (16, 'Cobra', 'Bhujangasana', null, null),
  (17, 'Locust', 'Salabhasana', null, null), 
  (18, 'Full Locust', 'Poorna Salabhasana', null, null),
  (19, 'Floor Bow Pose', 'Dhanurasana', null, null),
  (20, 'Fixed Firm', 'Supta Vajrasana', null, null),
  (21, 'Half Tortoise', 'Ardha Kurmasana', null, null),
  (22, 'Camel', 'Ustrasana', null, null),
  (23, 'Rabbit', 'Sasangasana', null, null),
  (24, 'Head-to-Knee With Stretching', ' Janushirasana with Paschimottanasana', null, null),
  (25, 'Spine Twisting', 'Ardha Matsyendrasana', null, null),
  (26, 'Blowing In Firm', 'Kapalbhati-in-Vajrasana', null, null);
